...
// StoreLocator
#define COCOAPODS_POD_AVAILABLE_StoreLocator
#define COCOAPODS_VERSION_MAJOR_StoreLocator 0
#define COCOAPODS_VERSION_MINOR_StoreLocator 1
#define COCOAPODS_VERSION_PATCH_StoreLocator 0
